...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin) {
    ...
    if (counter / 2 == button_count)
    {
        __HAL_TIM_SET_COMPARE(&TimHandle2, TIM_CHANNEL_1, 100);
    } else if (counter / 2 < button_count){
        __HAL_TIM_SET_COMPARE(&TimHandle2, TIM_CHANNEL_1, 20);
    }
